...
void  local_optimizer(fptr fun, int nd, double* lb,
                       double* ub, double* value, double* gbest, int ni_stop, double tol);

void pso_optimization(fptr fun, int np, int nd, int ni, double* lb, double* ub,
                      double* value, double* gbest, int ni_stop, double tol);

void multi_pso_optimization( fptr fun, int np, int nd, int ni, int maxRun, int* type, double* lb,
                          double* ub, double* value, double* gbest, int ni_stop, double tol);

void  multi_pso_local_optimizer(fptr fun, int np, int nd, int ni, int maxRun,
                    int* type, double* lb, double* ub, double* value, double* gbest, int ni_stop, double tol);
